...
public class MultipartStream {
     ...
     *
     * @throws net.myvietnam.mvncore.web.fileupload.MultipartStream.MalformedStreamException if the stream ends unexpecetedly or
     ...
     *                 stream.
     *
     * @throws net.myvietnam.mvncore.web.fileupload.MultipartStream.IllegalBoundaryException if the <code>boundary</code>
     ...
     *
     * @throws net.myvietnam.mvncore.web.fileupload.MultipartStream.MalformedStreamException if the stream ends unexpecetedly.
     */
     ...
     * #MultipartStream(java.io.InputStream,byte[],int) constructor}).
     *
     * @param output The <code>Stream</code> to write data into.
     *
     * @return the amount of data written.
     *
     * @throws net.myvietnam.mvncore.web.fileupload.MultipartStream.MalformedStreamException if the stream ends unexpectedly.
