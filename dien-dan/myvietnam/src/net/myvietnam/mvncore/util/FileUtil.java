...
public final class FileUtil {
    ...
    public final static String[] FILE_EXTENSION_TYPE_IMAGE = {".jpeg", ".jpg", ".png", ".gif", ".bmp", ".ico", ".tiff"};
    public final static String[] FILE_EXTENSION_TYPE_MOVIE = {".mpg", ".mov", ".wmv", ".avi", ".viv"};
    public final static String[] FILE_EXTENSION_TYPE_FLASH = {".swf"};
    public final static String[] FILE_EXTENSION_TYPE_AUDIO = {".mp3", ".mp2", ".wma", ".ram", ".wav"};
    public final static String[] FILE_EXTENSION_TYPE_DOC   = {".txt", ".doc", ".odt", ".xls", ".pdf", ".ppt"};
