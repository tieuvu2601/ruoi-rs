/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/util/MailUtil.java,v 1.65.2.1 2010/04/27 11:27:31 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.65.2.1 $
 * $Date: 2010/04/27 11:27:31 $
 *
 * ====================================================================
 *
...
public final class MailUtil {
    ...
    public static MailMessageStruct[] receiveEmail(String popServer, String popUser, String popPassword) {

        Store store = null;
        Folder folder = null;
        MailMessageStruct[] mailMessageStructsArray = null;
        String provider = "pop3";
        if (MVNCoreConfig.getReceiveMailConfig().isUseSecureConnection()) {
            provider = "pop3s";
        }
        ...
        try {
            ...
            Properties props = new Properties();
            props.put("mail.pop3.port", String.valueOf(MVNCoreConfig.getReceiveMailConfig().getPort()));
