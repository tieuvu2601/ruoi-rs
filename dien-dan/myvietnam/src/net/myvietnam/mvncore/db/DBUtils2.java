/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/db/DBUtils2.java,v 1.7 2008/05/30 04:18:36 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.7 $
...
public final class DBUtils2 {
    ...
    private static final Log log = LogFactory.getLog(DBUtils2.class);
     ...
     * @throws java.sql.SQLException : if cannot get a connection from the pool
     */
    public static Connection getConnection() throws SQLException {
        ...
        if (useDatasource) {
            ...
            if (connectionManager != null) {
                ...
                log.fatal("Assertion: DBUtils2.connectionManager == null");
            }
        }
