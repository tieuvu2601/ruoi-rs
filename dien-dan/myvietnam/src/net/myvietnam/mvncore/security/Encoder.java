/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/security/Encoder.java,v 1.30 2008/05/29 17:43:42 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.30 $
...
public final class Encoder {
    ...
    public static String encodeURL(String input) {
        try {
            ...
            log.fatal("Assertion, should never happen", e);
