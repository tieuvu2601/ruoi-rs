/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/importexport/jive/ImportJive.java,v 1.13 2008/05/30 18:08:38 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.13 $
...
/**
 * @author Igor Manic
 * @version $Revision: 1.13 $, $Date: 2008/05/30 18:08:38 $
 * <br/>
 * <code>ImportJive</code> class encapsulates processing
 * of Jive's XMLs, and imports all the data into MVN Forum database.
 * For details see {@link #importXml(java.io.File, HttpServletRequest, HttpServletResponse, int, String, java.util.Calendar, String, boolean, java.util.Vector, int)}
 * <br/>
...
// =================================================================
     ...
     * {@link #importXml(java.io.File, HttpServletRequest, HttpServletResponse, int, String, java.util.Calendar, String, boolean, java.util.Vector, int)}.
     *
