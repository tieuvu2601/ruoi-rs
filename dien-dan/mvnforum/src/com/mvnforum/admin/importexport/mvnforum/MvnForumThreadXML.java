/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/importexport/mvnforum/MvnForumThreadXML.java,v 1.9 2007/01/15 10:27:35 dungbtm Exp $
 * $Author: dungbtm $
 * $Revision: 1.9 $
...
/**
 * @author Igor Manic
 * @version $Revision: 1.9 $, $Date: 2007/01/15 10:27:35 $
 * <br/>
...
public class MvnForumThreadXML {
    ...
    ObjectNotFoundException, DatabaseException, ForeignKeyNotFoundException, BadInputException {
        ...
        threadXML.addThread(threadMemberName, threadLastPostMemberName,
                            ...
                            threadIcon, threadDuration, threadAttachCount, threadShowVMS);
        threadCreated=true;
