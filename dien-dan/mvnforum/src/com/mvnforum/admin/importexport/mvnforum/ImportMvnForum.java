/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/importexport/mvnforum/ImportMvnForum.java,v 1.17 2008/05/30 18:08:37 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.17 $
...
/**
 * @author Igor Manic
 * @version $Revision: 1.17 $, $Date: 2008/05/30 18:08:37 $
 * <br/>
 ...
 * For details see {@link #importXml(java.io.File, HttpServletRequest, HttpServletResponse, int, String, java.util.Calendar, String, boolean, int)}
 * and {@link #importZip(java.io.File, HttpServletRequest, HttpServletResponse, int, String, java.util.Calendar, String, boolean, int)}
 * <br/>
...
public final class ImportMvnForum extends ImportWebHelper {
    ...
    /** Message log. */
    private static final Log log = LogFactory.getLog(ImportMvnForum.class);
...
// =================================================================
     ...
     * and calls {@link #processXml(java.io.File, java.util.Calendar)} to do actual processing.<br/>
     *
     ...
     * and imports the data into the MVN Forum system. It clears the database
     * and files, does neccessary setup (including startup of message output),
     * extracts the files from ZIP, and calls {@link #processXml(java.io.File, java.util.Calendar)}
...
// =================================================================
     ...
     * {@link #importXml(java.io.File, HttpServletRequest, HttpServletResponse, int, String, java.util.Calendar, String, boolean, int)}.
     *
     * @param inputFile MVN Forum XML file to be imported.
     * @param importTime The moment when import process was started.
     *
     * @exception java.io.IOException If there is an I/O error while processing XML file.
     * @exception org.xml.sax.SAXException If there is an error while parsing XML file.
     ...
     * @see com.mvnforum.admin.ImportWebHelper#addMessage(String)
     *
     */
     ...
     *
     * @param message Message to be written to output.
     * @see com.mvnforum.admin.ImportWebHelper#addImportantMessage(String)
     *
     */
