/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/ThreadXML.java,v 1.15 2007/10/09 11:09:14 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.15 $
 * $Date: 2007/10/09 11:09:14 $
 *
 * ====================================================================
 *
...
public class ThreadXML {
    ...
    public void addThread(String memberName, String lastPostMemberName,
                          ...
                          String threadIcon, String threadDuration, String threadAttachCount, String threadShowVMS)
        ...
        if (parentForumID<0) {
            ...
            Timestamp threadCreationDate1;
            Timestamp threadLastPostDate1;
            int threadType1;
            int threadPriority1;
            int threadOption1;
            int threadStatus1;
            ...
            try {
                ...
                threadShowVMS1 = XMLUtil.stringToIntDef(threadShowVMS, 0);
            ...
            this.threadID = DAOFactory.getThreadDAO().createThread(parentForumID,
                                ...
                                threadReplyCount1, threadIcon, threadDuration1, threadAttachCount1, threadShowVMS1);
        }
    }
    ...
    public void addThreadWatch(String memberName,
        ...
        int watchOption1;
        int watchStatus1;
        Timestamp watchCreationDate1;
        Timestamp watchLastSentDate1;
        Timestamp watchEndDate1;
    ...
    public void addFavoriteThread(String memberName,
        ...
        Timestamp favoriteCreationDate1;
        int favoriteType1;
        int favoriteOption1;
        int favoriteStatus1;
