/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/ForumXML.java,v 1.16 2007/10/09 11:09:13 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.16 $
 * $Date: 2007/10/09 11:09:13 $
 *
 * ====================================================================
 *
...
public class ForumXML {
    ...
    DatabaseException, ForeignKeyNotFoundException {
        ...
        if ((forumName==null) || (forumName.equals(""))) {
            ...
            Timestamp forumCreationDate1;
            Timestamp forumModifiedDate1;
            Timestamp forumLastPostDate1;
            int forumOrder1;
            int forumType1;
