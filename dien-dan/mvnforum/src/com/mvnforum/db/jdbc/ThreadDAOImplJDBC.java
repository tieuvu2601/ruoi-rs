/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/db/jdbc/ThreadDAOImplJDBC.java,v 1.76 2008/05/30 04:41:34 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.76 $
...
public class ThreadDAOImplJDBC implements ThreadDAO {
    ...
    private static final Log log = LogFactory.getLog(ThreadDAOImplJDBC.class);
    ...
    private void create(int forumID, String memberName, String lastPostMemberName,
                        ...
                        String threadIcon, int threadDuration, int threadAttachCount, int threadShowVMS)
        ...
        PreparedStatement statement = null;
        StringBuffer sql = new StringBuffer(512);
        sql.append("INSERT INTO " + TABLE_NAME + " (ForumID, MemberName, LastPostMemberName, ThreadTopic, ThreadBody, ThreadVoteCount, ThreadVoteTotalStars, ThreadCreationDate, ThreadLastPostDate, ThreadType, ThreadPriority, ThreadOption, ThreadStatus, ThreadHasPoll, ThreadViewCount, ThreadReplyCount, ThreadIcon, ThreadDuration, ThreadAttachCount, ThreadShowVMS)");
        sql.append(" VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        try {
            connection = DBUtils.getConnection();
            statement = connection.prepareStatement(sql.toString());
            ...
            statement.setInt(20, threadShowVMS);
    ...
    public int createThread(int forumID, String memberName, String lastPostMemberName,
        ...
        create(forumID, memberName, lastPostMemberName, threadTopic, threadBody, threadVoteCount, threadVoteTotalStars, threadCreationDate, threadLastPostDate, threadType, threadPriority,threadOption, threadStatus, threadHasPoll, threadViewCount, threadReplyCount, threadIcon, threadDuration, threadAttachCount, threadShowVMS);
        int threadID = 0;
        try {
    ...
    public void updateThreadShowVMS(int threadID,
                                        int vmsShow)
        throws ObjectNotFoundException, DatabaseException {
        ...
        PreparedStatement statement = null;
        StringBuffer sql = new StringBuffer(512);
        sql.append("UPDATE " + TABLE_NAME + " SET ThreadShowVMS = ?");
        sql.append(" WHERE ThreadID = ?");
        try {
            connection = DBUtils.getConnection();
            statement = connection.prepareStatement(sql.toString());
    ...
    public ThreadBean getThread(int threadID)
        ...
        ResultSet resultSet = null;
        StringBuffer sql = new StringBuffer(512);
        sql.append("SELECT ForumID, MemberName, LastPostMemberName, ThreadTopic, ThreadBody, ThreadVoteCount, ThreadVoteTotalStars, ThreadCreationDate, ThreadLastPostDate, ThreadType, ThreadPriority, ThreadOption, ThreadStatus, ThreadHasPoll, ThreadViewCount, ThreadReplyCount, ThreadIcon, ThreadDuration, ThreadShowVMS");
        sql.append(" FROM " + TABLE_NAME);
        sql.append(" WHERE ThreadID = ?");
        try {
            connection = DBUtils.getConnection();
            ...
            bean.setThreadShowVMS(resultSet.getInt("ThreadShowVMS"));
            return bean;
        } catch(SQLException sqle) {
            log.error("Sql Execution Error!", sqle);
    ...
    private Collection getBeans_withSortSupport_limit_general(int offset, int rowsToReturn, String sort, String order, boolean enable, boolean onlyNoReply, boolean checkForumStatus, int status, int category, int forum)
        ...
        Collection retValue = new ArrayList();
        StringBuffer sql = new StringBuffer(512);
        sql.append("SELECT ThreadID, thread.ForumID, MemberName, thread.LastPostMemberName, ThreadTopic, ThreadBody, ThreadVoteCount, ThreadVoteTotalStars, ThreadCreationDate, ThreadLastPostDate, ThreadType, ThreadPriority, ThreadOption, ThreadStatus, ThreadHasPoll, ThreadViewCount, ThreadReplyCount, ThreadIcon, ThreadDuration, ThreadAttachCount, ThreadShowVMS");
        sql.append(" FROM " + TABLE_NAME + " thread");
        if (checkForumStatus) {
            sql.append(", " + ForumDAO.TABLE_NAME + " forum");
        }
    ...
    private Collection getBeans_inForum_withSortSupport_limit_general(int forumID, int offset, int rowsToReturn, String sort, String order, boolean enable, boolean onlyNormalThread)
        ...
        Collection retValue = new ArrayList();
        StringBuffer sql = new StringBuffer(512);
        sql.append("SELECT ThreadID, MemberName, LastPostMemberName, ThreadTopic, ThreadBody, ThreadVoteCount, ThreadVoteTotalStars, ThreadCreationDate, ThreadLastPostDate, ThreadType, ThreadPriority, ThreadOption, ThreadStatus, ThreadHasPoll, ThreadViewCount, ThreadReplyCount, ThreadIcon, ThreadDuration, ThreadAttachCount, ThreadShowVMS");
        sql.append(" FROM " + TABLE_NAME);
        sql.append(" WHERE ForumID = ? ");
        if (onlyNormalThread) {
            sql.append(" AND ThreadType = ").append(ThreadBean.THREAD_TYPE_DEFAULT);
