/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/common/kg/KGUtils.java,v 1.28 2008/06/01 17:22:06 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.28 $
...
public final class KGUtils {
    ...
    private static final Log log = LogFactory.getLog(KGUtils.class);
    ...
    public static void addNewMember(HttpServletRequest request, String memberName, String memberPassword, String memberEmail, Date memberBirthday)
        ...
        if (memberBirthday == null) {
            memberBirthday          = new Date(now.getTime());
        }
