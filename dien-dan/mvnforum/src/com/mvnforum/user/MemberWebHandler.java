...
public class MemberWebHandler {
    ...
    public void processAdd(GenericRequest request, GenericResponse response)
        ...
        String memberEmailConfirm   = GenericParamUtil.getParameterEmail(request, "MemberEmail");
...
//            memberLastname         = GenericParamUtil.getParameterFilter(request, "MemberFirstname", MVNForumConfig.isRequireRegisterFirstname());
        }
