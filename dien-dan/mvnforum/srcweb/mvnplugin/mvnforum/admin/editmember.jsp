<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/editmember.jsp,v 1.86 2008/06/24 01:40:04 lexuanttkhtn Exp $
 - $Author: lexuanttkhtn $
 - $Revision: 1.86 $
 - $Date: 2008/06/24 01:40:04 $
 -
 - ====================================================================
 -
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.common.member.status"/></td>
    <td>
      <select name="MemberStatus" size="1">
