<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/addgroup.jsp,v 1.80 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.80 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.admin.addgroup.title"/></mvn:title>
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <fmt:message key="mvnforum.admin.addgroup.title"/>
    </td>
  </tr>
</table>
<br/>
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  <tr class="pagedesc">
    <td>
      <fmt:message key="mvnforum.admin.addgroup.info"/> 
    </td>
  </tr>
</table>
<br/>

<form action="<%=urlResolver.encodeURL(request, response, "addgroupprocess", URLResolverService.ACTION_URL)%>" method="post" name="submitform">
<%=urlResolver.generateFormAction(request, response, "addgroupprocess")%>
<mvn:cssrows>
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  <tr class="portlet-section-header">
    <td colspan="2"><fmt:message key="mvnforum.admin.addgroup.enter_information"/></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td valign="top"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.group.group_name"/>:</td>
    <td><input type="text" name="GroupName" size="60" onkeyup="initTyper(this);" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td valign="top"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.group.group_description"/>:</td>
    <td><textarea cols="60" rows="6" name="GroupDesc" onkeyup="initTyper(this);"></textarea></td>
  </tr>
<%--   
  <tr class="<mvn:cssrow/>">
    <td valign="top"><fmt:message key="mvnforum.common.group.group_owner_name"/>:</td>
    <td><input type="text" name="GroupOwnerName" size="60" /></td>
  </tr>
--%>  
