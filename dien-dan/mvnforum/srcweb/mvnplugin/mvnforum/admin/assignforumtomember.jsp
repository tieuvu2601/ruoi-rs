<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/assignforumtomember.jsp,v 1.84 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.84 $
...
function ValidateForm() {
  if (document.submitform.forum.value == '') {
    alert("Vui lòng chọn một thành viên để tiếp tục.");
    return false;
  }
  return true;
}
