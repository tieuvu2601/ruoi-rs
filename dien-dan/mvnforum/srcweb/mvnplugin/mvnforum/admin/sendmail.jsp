<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/sendmail.jsp,v 1.95 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.95 $
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    <td align="right" nowrap="nowrap"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.email.from"/>:</td>
    <td class="portlet-font"><%=from%></td>
  </tr>
  <tr class="<mvn:cssrow/>" id="To">
    <td align="right" nowrap="nowrap"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.email.to"/>:</td>
  ...
  <tr class="<mvn:cssrow/>">
    <td align="right" nowrap="nowrap"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.email.subject"/>:</td>
    <td class="portlet-font"><%=previewSubject%></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td align="right" valign="top" nowrap="nowrap"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.email.message"/>:</td>
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    <td align="right" nowrap="nowrap"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.email.from"/>:</td>
    <td>
      <input type="text" name="From" value="<%=from%>" size="60" /> 
  ...
  <tr class="<mvn:cssrow/>" id="To">
    <td align="right" valign="top" nowrap="nowrap"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.email.to"/>:</td>
  ...
  <tr class="<mvn:cssrow/>">
    <td align="right" nowrap="nowrap"><fmt:message key="mvnforum.common.email.cc"/>:</td>
    <td><input type="text" name="Cc" value="<%=cc%>" size="60" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td align="right" nowrap="nowrap"><fmt:message key="mvnforum.common.email.bcc"/>:</td>
    <td><input type="text" name="Bcc" size="60" value="<%=bcc%>" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td align="right" nowrap="nowrap"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.email.subject"/>:</td>
    <td><input type="text" name="Subject" value="<%=subject%>" size="60" onkeyup="initTyper(this);"/></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td align="right" valign="top" nowrap="nowrap"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.email.message"/>:</td>
    <td><textarea cols="60" rows="15" name="Message" onkeyup="initTyper(this);"><%=message%></textarea></td>
  </tr>
