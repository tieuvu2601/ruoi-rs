<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/assignforumtogroup.jsp,v 1.86 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.86 $
...
function ValidateForm() {
  if (document.submitform.forum.value == '') {
    alert("Vui lòng chọn một diễn đàn để tiếp tục.");
    return false;
  }
  return true;
}
