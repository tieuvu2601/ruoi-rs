<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/editmembertitle.jsp,v 1.64 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.64 $
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    <td valign="top"><fmt:message key="mvnforum.common.member.member_title"/>:</td>
    <td><textarea cols="60" rows="5" name="MemberTitle" onkeyup="initTyper(this);"><%=memberBean.getMemberTitle()%></textarea></td>
  </tr>
