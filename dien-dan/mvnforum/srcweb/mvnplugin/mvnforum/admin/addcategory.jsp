<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/addcategory.jsp,v 1.91 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.91 $
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td valign="top"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.category.category_parent"/>:</td>
  <td>
  <% } %>
  <%--       
...
%>
  ...
  <tr class="<mvn:cssrow/>">
    ...
    <td><input type="text" name="CategoryName" size="60" onkeyup="initTyper(this);" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    ...
    <td><textarea cols="60" rows="6" name="CategoryDesc" onkeyup="initTyper(this);"></textarea></td>
  </tr>
