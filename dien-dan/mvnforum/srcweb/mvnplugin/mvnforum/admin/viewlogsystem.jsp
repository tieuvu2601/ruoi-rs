<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/viewlogsystem.jsp,v 1.62 2008/06/13 09:23:16 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.62 $
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  <tr class="pagedesc">
    <td>
      ...
      <a href="<%=urlResolver.encodeURL(request, response, "backupsystemlog", URLResolverService.ACTION_URL)%>" class="command"><fmt:message key="mvnforum.admin.viewlogsystem.backup_system_log"/></a> <fmt:message key="mvnforum.admin.viewlogsystem.info_of_backupsystemlog"/><br/>
      <a href="<%=urlResolver.encodeURL(request, response, "backupsystemlog?empty=yes", URLResolverService.ACTION_URL)%>" class="command"><fmt:message key="mvnforum.admin.viewlogsystem.backup_system_log_and_empty"/></a> <fmt:message key="mvnforum.admin.viewlogsystem.info_of_backupsystemlog"/>
    </td>
  </tr>
</table>
