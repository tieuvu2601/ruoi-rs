<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/addforum.jsp,v 1.93 2008/06/13 09:23:17 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.93 $
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td valign="top"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.category.category_name"/>:</td>
    <td>
<%--     
...
<%}%>
  ...
  <tr class="<mvn:cssrow/>">
    ...
    <td><input type="text" name="ForumName" size="62" onkeyup="initTyper(this);" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    ...
    <td><textarea cols="60" rows="10" name="ForumDesc" onkeyup="initTyper(this);"></textarea></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td valign="top"><fmt:message key="mvnforum.common.forum.forum_owner_name"/>:</td>
    <td><input type="text" name="ForumOwnerName" size="30" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
