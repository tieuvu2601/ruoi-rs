<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/index.jsp,v 1.103 2008/06/13 09:23:17 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.103 $
...
<table width="95%" align="center">
  <tr class="nav">
    <td><img src="<%=contextPath%>/mvnplugin/mvnforum/images/check_icon.png" alt="" /></td>
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    <td width="30%"><fmt:message key="mvnforum.admin.index.cache_report_member"/> - <a href="<%=urlResolver.encodeURL(request, response, "clearcache?target=member", URLResolverService.ACTION_URL)%>" class="command"><fmt:message key="mvnforum.common.action.clear_cache"/></a></td>
    <td><%=MemberCache.getInstance().getEfficiencyReport()%></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.admin.index.cache_report_post"/> - <a href="<%=urlResolver.encodeURL(request, response, "clearcache?target=post", URLResolverService.ACTION_URL)%>" class="command"><fmt:message key="mvnforum.common.action.clear_cache"/></a></td>
    <td><%=PostCache.getInstance().getEfficiencyReport()%></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.admin.index.cache_report_thread"/> - <a href="<%=urlResolver.encodeURL(request, response, "clearcache?target=thread", URLResolverService.ACTION_URL)%>" class="command"><fmt:message key="mvnforum.common.action.clear_cache"/></a></td>
    <td><%=ThreadCache.getInstance().getEfficiencyReport()%></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.admin.index.cache_report_forum"/> - <a href="<%=urlResolver.encodeURL(request, response, "clearcache?target=forum", URLResolverService.ACTION_URL)%>" class="command"><fmt:message key="mvnforum.common.action.clear_cache"/></a></td>
    <td><%=ForumCache.getInstance().getEfficiencyReport()%></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.admin.index.cache_report_category"/> - <a href="<%=urlResolver.encodeURL(request, response, "clearcache?target=category", URLResolverService.ACTION_URL)%>" class="command"><fmt:message key="mvnforum.common.action.clear_cache"/></a></td>
    <td><%=CategoryCache.getInstance().getEfficiencyReport()%></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td colspan="2" align="center"><a href="<%=urlResolver.encodeURL(request, response, "clearcache?target=all", URLResolverService.ACTION_URL)%>" class="command"><fmt:message key="mvnforum.common.action.clear_all_cache"/></a></td>
  </tr>
</table>
</mvn:cssrows>
<%}/*if can admin system*/%>
