<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/addmembergroup.jsp,v 1.70 2008/06/13 09:23:17 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.70 $
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    <td valign="top"><span class="requiredfield">*</span> <fmt:message key="mvnforum.common.members"/>:</td>
    <td><textarea cols="60" rows="10" name="MemberNames"></textarea></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td valign="top"><fmt:message key="mvnforum.common.group.privilege"/>:</td>
    <td>
