<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/assigngrouptoforum.jsp,v 1.79 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.79 $
...
function ValidateForm() {
  if (document.submitform.group.value == -1) {
    alert("Vui lòng chọn một nhóm để phân quyền"); // Please choose a group to continue.
    return false;
  }
  return true;
}
