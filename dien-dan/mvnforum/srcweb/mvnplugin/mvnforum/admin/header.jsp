<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/header.jsp,v 1.125 2008/06/13 09:23:19 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.125 $
...
<div class="top_navigation">
    <div class="top_navigation_text">
        ...
        <div style="float:right;">
            ...
            <%} %>
            <div class="zoneTitle">
                <fmt:message key="mvnforum.admin.header.admin_zone"/>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="navigation_text">
        <div class="navigation">
            <ul>
                ...
                <li><a href="<%=urlResolver.encodeURL(request, response, "index", URLResolverService.RENDER_URL, "view" /*portlet mode */)%>" class="topmenu"><fmt:message key="mvnforum.admin.header.forum_index"/></a></li>
                <li class="space"></li>
                <% } %>
                <li><a href="<%=urlResolver.encodeURL(request, response, "index")%>" class="topmenu"><fmt:message key="mvnforum.admin.header.admin_index"/></a></li>
                <li class="space"></li>
                <%if (permission.canAdminSystem()) {%>
                <li><a href="<%=urlResolver.encodeURL(request, response, "misctasks")%>" class="topmenu"><fmt:message key="mvnforum.admin.misctasks.title"/></a></li>
                <li class="space"></li>
                <% } %>
                <%if ( permission.canEditAnyForum() || permission.canAddForum() ) {%>
                <li><a href="<%=urlResolver.encodeURL(request, response, "forummanagement")%>" class="topmenu"><fmt:message key="mvnforum.admin.forummanagement.title"/></a></li>
                <li class="space"></li>
                <% } %>
                <%if (permission.canModerateUser()) {%>
                <li><a href="<%=urlResolver.encodeURL(request, response, "usermanagement")%>" class="topmenu"><fmt:message key="mvnforum.admin.usermanagement.title"/></a></li>
                <li class="space"></li>
                <% } %>
                <%if (permission.canAdminSystem()) {%>
                <li><a href="<%=urlResolver.encodeURL(request, response, "groupmanagement")%>" class="topmenu"><fmt:message key="mvnforum.admin.groupmanagement.title"/></a></li>
                <li class="space"></li>
                <% } %>
                <%if (permission.canSendMail()) {%>
                <li><a href="<%=urlResolver.encodeURL(request, response, "sendmail")%>" class="topmenu"><fmt:message key="mvnforum.admin.sendmail.title"/></a></li>
                <li class="space"></li>
                <% } %>
            </ul>
        </div>
