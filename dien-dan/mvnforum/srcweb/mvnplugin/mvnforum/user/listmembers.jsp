<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/listmembers.jsp,v 1.106 2008/06/13 09:23:22 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.106 $
...
<pg:item>
  <tr class="<mvn:cssrow/>">
    ...
    <td nowrap="nowrap"><%if (MVNForumConfig.getEnableShowFirstName()){%><%=memberBean.getMemberFirstname()%><%}%> </td>
    <%}%>
    <%if (MVNForumConfig.getEnableShowEmail()) { %>
    <td nowrap="nowrap">
    <%if ((memberBean.getMemberID()==0) || (memberBean.getMemberID()==MVNForumConstant.MEMBER_ID_OF_GUEST)) {%>
