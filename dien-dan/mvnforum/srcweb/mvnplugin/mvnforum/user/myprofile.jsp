<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/myprofile.jsp,v 1.122 2008/06/24 03:56:14 lexuanttkhtn Exp $
 - $Author: lexuanttkhtn $
 - $Revision: 1.122 $
 - $Date: 2008/06/24 03:56:14 $
 -
 - ====================================================================
 -
...
<% } //enable avatar%>
    <td valign="top" nowrap="nowrap">
      ...
      <a class="command" href="<%=urlResolver.encodeURL(request, response, "changesignature")%>"><fmt:message key="mvnforum.user.changesignature.title"/></a>
      <%} %>
    </td>
    <td width="50%" valign="top" nowrap="nowrap">
      ...
      <% } %>  
      <a class="command" href="<%=urlResolver.encodeURL(request, response, "deletecookieprocess", URLResolverService.ACTION_URL)%>"><fmt:message key="mvnforum.user.myprofile.link.delete_cookie"/></a><br/>
