<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/searchattachments.jsp,v 1.32 2008/06/13 09:23:22 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.32 $
...
<table width="95%" align="center">
  <tr class="nav">
    ...
    <a class="nav" href="<%=urlResolver.encodeURL(request, response, "listattachments")%>"><fmt:message key="mvnforum.user.listattachments.title"/></a>&nbsp;&raquo;&nbsp;
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    ...
    <td><input type="text" size="60" name="key" value="<%=key%>" onkeyup="initTyper(this);" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.user.searchattachments.by_name"/></td>
    <td><input type="text" size="60" name="attachmentname" value="<%=attachmentName%>" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><fmt:message key="mvnforum.user.search.in_category_forum"/></td>
    <td>
<%--
      <select name="forum">
