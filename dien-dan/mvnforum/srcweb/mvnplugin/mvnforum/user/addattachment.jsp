<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/addattachment.jsp,v 1.84 2008/06/13 09:23:22 phuongpdd Exp $
 - $Author: phuongpdd $
 - $Revision: 1.84 $
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td valign="top"><fmt:message key="mvnforum.user.addattachment.attach_desc"/></td>
