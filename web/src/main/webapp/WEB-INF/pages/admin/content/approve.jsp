...
<script type="text/javascript">
    ...
    $(function() {
    	$("#deleteConfirmLink").click(function() {
            ...
            bootbox.confirm('<fmt:message key="delete.confirm"/>', '<fmt:message key="delete.confirm.title"/>', function(r) {
          		   if(r) {
        ...
        $('a[name="deleteLink"]').click(function(eventObj) {
            bootbox.confirm('<fmt:message key="delete.confirm.one"/>', '<fmt:message key="delete.confirm.title"/>', function(r) {
       		   if(r) {
