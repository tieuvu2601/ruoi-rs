...
<head>
    <title><fmt:message key="report.by.vote.management"/></title>
    <meta name="heading" contentEntity="<fmt:message key="report.by.vote.management"/>"/>
</head>
<div class="pathway">
    <fmt:message key="report.by.vote.management"/>
</div>

<c:url var="url" value="/admin/report/comment.html"/>
        ...
        <div class="box_container">
            ...
            <div class="form">
                <table width="100%" cellpadding="5" cellspacing="5" border="0">
                	<tr>
                		<td><fmt:message key="label.top.comment" /></td>
                		<td>
                			<select name="top">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <c:if test="${not empty items.totalItems && items.totalItems > 0}">
                                ...
                                <c:url var="export2ExcelURL" value="/admin/report/export/comment.html">
        ...
        <c:if test="${not empty items.crudaction}">
         <div class="box_container" >
            ...
            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${url}"
                partialList="true" sort="external" size="${items.totalItems}" defaultsort="4" defaultorder="descending" uid="tableList" pagesize="${items.maxPageItems}" class="table bright_blue_body" export="false">
