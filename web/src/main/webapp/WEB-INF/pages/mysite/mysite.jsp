                    ...
                    <form:form commandName="items" action="${url}" method="post" id="listForm">
                        ...
                        <div>
                             ...
                             <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${url}"
                                 ...
                                 <display:setProperty name="paging.banner.some_items_found"><span class="pagebanner pull-left">Hiển thị {2} đến {3} của {0}.</span> </display:setProperty>
                                 <display:setProperty name="paging.banner.all_items_found"><span class="pagelinks pull-right">{0} tài liệu được tìm thấy.</span> </display:setProperty>
                             </display:table>
                            <div class="clear"></div>
                        </div>
