        ...
        <div class="col-sm-5">
            ...
            <div class="blog-thumb margin-bottom-20">
                <div class="blog-thumb-hover">
                    <img src="assets/img/blog/img42.jpg" alt="">
            ...
            <div class="blog-thumb margin-bottom-20">
                <div class="blog-thumb-hover">
                    <img src="assets/img/blog/img10.jpg" alt="">
            ...
            <div class="blog-thumb margin-bottom-20">
                <div class="blog-thumb-hover">
                    <img src="assets/img/blog/img18.jpg" alt="">
                    <a class="hover-grad" href="blog_single.html"><i class="fa fa-volume-up"></i></a>
                </div>
                <div class="blog-thumb-desc">
            ...
            <div class="blog-thumb margin-bottom-20">
                <div class="blog-thumb-hover">
                    <img src="assets/img/blog/img20.jpg" alt="">
            ...
            <div class="blog-thumb">
                <div class="blog-thumb-hover">
                    <img src="assets/img/blog/img13.jpg" alt="">
                    <a class="hover-grad" href="blog_single.html"><i class="fa fa-photo"></i></a>
                </div>
                <div class="blog-thumb-desc">
...
<div class="tab-pane fade" id="tab-v4-a2">
    <div class="row">
        ...
        <div class="col-sm-5">
            ...
            <div class="blog-thumb margin-bottom-20">
                <div class="blog-thumb-hover">
                    <img src="assets/img/blog/img24.jpg" alt="">
                    <a class="hover-grad" href="blog_single.html"><i class="fa fa-photo"></i></a>
                </div>
                <div class="blog-thumb-desc">
...
<div class="tab-pane fade" id="tab-v4-a3">
    <div class="row">
        ...
        <div class="col-sm-5">
            ...
            <div class="blog-thumb margin-bottom-20">
                <div class="blog-thumb-hover">
                    <img src="assets/img/blog/img11.jpg" alt="">
                    <a class="hover-grad" href="blog_single.html"><i class="fa fa-video-camera"></i></a>
                </div>
                <div class="blog-thumb-desc">
            ...
            <div class="blog-thumb margin-bottom-20">
                <div class="blog-thumb-hover">
                    <img src="assets/img/blog/img19.jpg" alt="">
                    <a class="hover-grad" href="blog_single.html"><i class="fa fa-photo"></i></a>
                </div>
                <div class="blog-thumb-desc">
...
<div class="blog-carousel margin-bottom-50">
    ...
    <div class="item">
        <div class="row">
            <div class="col-sm-5 sm-margin-bottom-20">
                <img class="img-responsive" src="assets/img/blog/img39.jpg" alt="">
            </div>
            <div class="col-sm-7">
                <div class="blog-grid">
                    <h3><a href="blog_single.html">New 5 star hotel in Sydney</a></h3>
                    <ul class="blog-grid-info">
                        <li>Evan Bartlett</li>
                        <li>Mar 6, 2015</li>
                        <li><a href="#"><i class="fa fa-comments"></i> 0</a></li>
    ...
    <div class="item">
        <div class="row">
            <div class="col-sm-5 sm-margin-bottom-20">
                <img class="img-responsive" src="assets/img/blog/img40.jpg" alt="">
            </div>
            <div class="col-sm-7">
                <div class="blog-grid">
                    <h3><a href="blog_single.html">Prepare yourself for summer</a></h3>
                    <ul class="blog-grid-info">
                        <li>Evan Bartlett</li>
                        <li>Mar 6, 2015</li>
                        <li><a href="#"><i class="fa fa-comments"></i> 0</a></li>
                ...
                <div class="carousel slide carousel-v2" id="portfolio-carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive" src="assets/img/blog/img18.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="assets/img/blog/img43.jpg" alt="">
                        </div>
                    </div>
                </div>
                <h3><a href="blog_single.html">Instagram style tips of the week</a></h3>
        ...
        <div class="col-sm-7">
            ...
            <div class="blog-grid md-margin-bottom-40">
                <div class="blog-grid-grad">
                    <img class="img-responsive" src="assets/img/blog/img23.jpg" alt="">
...
<div class="tab-pane fade" id="tab-v4-b2">
    <div class="row">
        <div class="col-sm-7">
            ...
            <div class="blog-grid md-margin-bottom-40">
                <div class="blog-grid-grad">
                    <img class="img-responsive" src="assets/img/blog/img33.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-photo"></i>
                    </a>
                </div>
        ...
        <div class="col-sm-5">
            ...
            <div class="blog-thumb-v2 margin-bottom-20">
                <div class="blog-thumb-grad">
                    <img src="assets/img/blog/img14.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-video-camera"></i>
                    </a>
                </div>
            ...
            <div class="blog-thumb-v2 margin-bottom-20">
                <div class="blog-thumb-grad">
                    <img src="assets/img/blog/img12.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-volume-up"></i>
                    </a>
                </div>
            ...
            <div class="blog-thumb-v2 margin-bottom-20">
                <div class="blog-thumb-grad">
                    <img src="assets/img/blog/img35.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-photo"></i>
                    </a>
                </div>
            ...
            <div class="blog-thumb-v2 margin-bottom-20">
                <div class="blog-thumb-grad">
                    <img src="assets/img/blog/img7.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-volume-up"></i>
                    </a>
                </div>
            ...
            <div class="blog-thumb-v2">
                <div class="blog-thumb-grad">
                    <img src="assets/img/blog/img37.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-video-camera"></i>
                    </a>
                </div>
...
<div class="tab-pane fade" id="tab-v4-b3">
    <div class="row">
        <div class="col-sm-7">
            ...
            <div class="blog-grid sm-margin-bottom-40">
                <div class="blog-grid-grad">
                    <img class="img-responsive" src="assets/img/blog/img32.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-volume-up"></i>
                    </a>
                </div>
        ...
        <div class="col-sm-5">
            ...
            <div class="blog-thumb-v2 margin-bottom-20">
                <div class="blog-thumb-grad">
                    <img src="assets/img/blog/img34.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-volume-up"></i>
                    </a>
                </div>
            ...
            <div class="blog-thumb-v2 margin-bottom-20">
                <div class="blog-thumb-grad">
                    <img src="assets/img/blog/img30.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-video-camera"></i>
                    </a>
                </div>
            ...
            <div class="blog-thumb-v2 margin-bottom-20">
                <div class="blog-thumb-grad">
                    <img src="assets/img/blog/img29.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-photo"></i>
                    </a>
                </div>
            ...
            <div class="blog-thumb-v2">
                <div class="blog-thumb-grad">
                    <img src="assets/img/blog/img31.jpg" alt="">
                    <a href="blog_single.html">
                        <i class="fa fa-volume-up"></i>
                    </a>
                </div>
