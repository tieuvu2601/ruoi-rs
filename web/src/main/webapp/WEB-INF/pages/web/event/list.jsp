                    ...
                    <c:forEach var="item" items="${items}">
                        ...
                        <article class="events-item page-row has-divider clearfix">
                            ...
                            <div class="details col-md-10 col-sm-9 col-xs-8">
                                <h3 class="title">
                                    <seo:url value="${item.title}" var="seoURL" prefix="/${item.categoryEntity.prefixUrl}/${portal:convertStringToUrl(item.categoryEntity.code)}/"/>
                                ...
                                <p class="desc">${itemData.description[0]}</p>
                            </div>
                        </article>
                    </c:forEach>
