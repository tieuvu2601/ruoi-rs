...
<div class="margin-bottom-30 about-me-container">
    ...
    <div class="latest-news">
        ...
        <h5><fmt:message key="site.email"/>: <a href="mailto:<fmt:message key="site.author.email"/>?subject=T%C6%B0%20v%E1%BA%A5n%20v%E1%BB%81%20d%E1%BB%B1%20%C3%A1n%20b%E1%BA%A5t%20%C4%91%E1%BB%99ng%20s%E1%BA%A3n"><strong><fmt:message key="site.author.email"/></strong></a></h5>
