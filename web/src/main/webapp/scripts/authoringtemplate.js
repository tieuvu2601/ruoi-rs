validateAddNodeToAuthoringTemplate = function() {
    ...
    if (1 == 1) {        //validateForm(validateElements)
        ...
        var html = '<tr id="tr_attribute_' + nodeName + '">'
                    ...
                    + '<td><a href="javascript:editAuthoringTemplateNode(\'' + nodeName + '\')"><i class="fa fa-edit"></i></a>'
                        + '<a href="javascript:deleteAuthoringTemplateNode(\'' + nodeName + '\')"><i class="fa fa-remove"></i></a>'
