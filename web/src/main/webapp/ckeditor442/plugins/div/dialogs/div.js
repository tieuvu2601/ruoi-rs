	...
	function divDialog( editor, command ) {
		...
		return {
			...
			contents: [
                        ...
                        children: [
                            {
                                type: 'text',
                                id: 'questionName',
                                requiredContent: 'div[questionName]',
                                label: editor.lang.common.questionName,
                                'default': ''
                            }
                        ]
                    },
                ...
                {
                    id: 'shadeImage',
                    label: editor.lang.common.shadeImage,
                    title: editor.lang.common.shadeImage,
                    elements: [
                        {
                            type: 'vbox',
                            padding: 1,
                                    ...
                                    children: [
                                        {
                                            type: 'text',
                                            id: 'sizeX',
                                            requiredContent: 'div[sizeX]',
                                            label: editor.lang.common.sizeX,
                                            'default': '',
                                        ...
                                        },
                                        {
                                            type: 'text',
                                            id: 'sizeY',
                                            requiredContent: 'div[sizeY]',
                                            label: editor.lang.common.sizeY,
                                            'default': '',
                                            validate: CKEDITOR.dialog.validate.integer( editor.lang.common.validateNumberFailed )
                                        }
                                    ]
                                    ...
                                    children: [
                                        {
                                            ...
                                            id: 'title',
                                            requiredContent: 'div[title]',
                                            label: editor.lang.common.shadeTitle,
                                            'default': ''
                                        ...
                                        },
                                        {
                                            type: 'select',
                                            id: 'editable',
                                            requiredContent: 'div[editable]',
                                            label: editor.lang.common.editable,
                                            'default': '',
                                            items: [
                                            [
                                                editor.lang.common.editAbleTrue,
                                                'true'
                                            ],
                                            [
                                                editor.lang.common.editAbleFalse,
                                                'false'
                                            ]
                                        ]
                                        }
