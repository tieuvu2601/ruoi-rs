...
public class ContentTagLibGetRecentNews extends TagSupport {
    @Autowired
    ...
    public int doStartTag() throws JspException {
        ...
        if(context != null && pageSize != null && var != null) {
            ...
            List<ContentEntity> recentNews = contentService.findByCategory(Constants.CATEGORY_RECENT_NEWS, 0, pageSize, Constants.CONTENT_PUBLISH);
            if(recentNews != null) {
                this.pageContext.setAttribute(this.var, recentNews);
            }
        }
