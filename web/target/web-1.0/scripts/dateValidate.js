...
if(i==2){this[i]=29}}
return this}
function isDate(dtStr,inputId){var daysInMonth=DaysArray(12)
...
if(strYear.length==2){strYear="20"+strYear;$("#"+inputId).val(strMonth+"/"+strDay+"/"+strYear);}
if(strYear.length!=4&&strYear!=2){return false;}
