                        ...
                        <div class="body  myCorner" data-corner="bottom 5px">
                            <div class="body_content">
                                <div class="content_item">
                                    <c:if test="${not empty currentContentItem.thumbnail}">
                                        <rep:href value="${currentContentItem.thumbnail}" var="imgURL"/>
                                        <div class="big_thumb_image">
                                            <img src="<c:url value="${imgURL}?w=590&h=300"/>" alt="${currentContentItem.title}">
                                        </div>
                                    </c:if>
                                    <br><br>
                                    <oscache:cache key="d_${currentContentItem.contentID}_${currentContentItem.modifiedDate}" duration="1800">
...
<script type="text/javascript" language="javascript">
    $(function(){
        $('#sliderRelatedArticles').carouFredSel({
            width: 558,
            prev: '#relatedPrev',
            next: '#relatedNext',
            auto: false
