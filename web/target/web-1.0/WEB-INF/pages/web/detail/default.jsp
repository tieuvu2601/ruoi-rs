                                    ...
                                    <div class="content_item">
                                        ...
                                        <div class="text">
                                            <c:forEach items="${currentContentItemContent}" var="itemContent">
                                                <c:forEach items="${itemContent.value}" var="value">
                                                    <p>${value}</p>
                                                </c:forEach>
                                            </c:forEach>
                                        </div>
                                    ...
                                    <div class="related_items">
                                        ...
                                        <ul>
                                            <c:forEach items="${relatedItems}" var="contentItem">
                                                <c:set var="prefix" value="/chi-tiet/${param.authoringTemplate}/"/>
	                                        ...
	                                        <div class="comment_items">
	                                        	...
	                                        	<form:form method="post" commandName="item" action="${url }" id="frmSearch">
		                                            <display:table name="item.listResults" cellspacing="0" cellpadding="0" style="margin-bottom: 2.5em;" requestURI="${url}" excludedParams="*"
	                                                 	...
	                                                 	<display:column>
			                                                <p>
			                                                    ${tableList.commentText}<br/>
			                                                    <span style="font: bold">${tableList.createdBy.firstName} - <fmt:formatDate value="${tableList.createdDate}" pattern="dd/MM/yyyy HH:mm:ss"/></span>
			                                                </p>
			                                                <hr/>
		                                                </display:column>
