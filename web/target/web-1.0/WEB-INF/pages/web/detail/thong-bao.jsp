...
<body class="sub_page">
    <div class="sub_page_panel">
        <div class="box_wrapper">
            <div class="sub_page_title"><str:truncateNicely lower="50" upper="60" appendToEnd="...">${currentContentItem.title}</str:truncateNicely></div>
                            ...
                            <div class="body  myCorner" data-corner="bottom 5px">
                                <div class="body_content">
                                    ...
                                    <div class="content_item">
                                        ...
                                        <c:if test="${not empty currentContentItemContent['attachments']}">
                                        <div class="attachments">
                                            <p style="font-weight: bold;text-decoration: underline;"><fmt:message key="content.attachments"/>:</p>
                                            <c:forEach items="${currentContentItemContent['attachments']}" var="attachment">
                                                <p><rep:href value="${attachment}"/></p>
                                            </c:forEach>
                                        </div>
                                        </c:if>
                                        <div class="author">
                                        ...
                                        <ul>
                                            <c:choose>
                                                <c:when test="${not empty department}">
                                                    <c:set var="prefix" value="/${prefixDepartmentURL}/${department.departmentID}/"/>
                                            ...
                                            <c:forEach items="${relatedItems}" var="contentItem">
                                                <seo:url prefix="${prefix}${contentItem.contentID}/" value="${contentItem.title}" var="seoURL"/>
                                                <li>
                                                    <div class="more">
