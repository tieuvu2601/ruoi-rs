                                    ...
                                    <ul class="feedback_detail_panel">
                                        ...
                                        <li>
                                            <div class="reply_panel">
                                                <c:url value="/tra-loi-y-kien.html" var="postURL"/>
                                                <form:form commandName="item" action="${postURL}">
                                                <table width="100%" cellpadding="0" cellspacing="5" border="0">
                                                    <tr>
                                                        <td valign="top" colspan="2">Nội dung phản hồi:</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <form:textarea path="feedbackReply.content" id="replyContent" rows="10" cssStyle="width:80%"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            ...
                                                            <input type="hidden" name="pojo.feedbackID" value="${item.pojo.feedbackID}"/>
                                                            <input type="submit" name="button_submit" value="Phản hồi"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                                </form:form>
