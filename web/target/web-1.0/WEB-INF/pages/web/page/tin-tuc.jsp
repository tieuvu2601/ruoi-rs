...
<body class="sub_page">
    <div class="sub_page_panel">
        <div class="box_wrapper">
            <div class="sub_page_title">${currentAuthoringTemplate.name}</div>
                                ...
                                <div class="body_content">
                                    ...
                                    <display:table name="contentItems" cellspacing="0" cellpadding="0" style="margin-bottom: 2.5em;" requestURI="${url}"
                                         ...
                                         <display:column>
                                            ...
                                            <seo:url prefix="/tin-tuc/${categoryPath}${tableList.contentID}/" value="${tableList.title}" var="seoURL"/>
                                            <rep:href var="imgURL" value="${tableList.thumbnail}"/>
                                            <div>
                                                <div class="title">
                                                ...
                                                <div class="text">
                                                    <div class="thumbnail">
                                                        <img src="${imgURL}?w=200&h=140"/>
                                                    </div>

                                                    <div class="brief">
                                                        ${contentItemContent['brief'][0]}
                                                        <p style="margin-top:10px;"><a href="${seoURL}"><img src="<c:url value="/themes/vms_stretch/images/detail_button.png"/>"/></a></p>
                                                    </div>
                                                </div>
                                                <div class="clear"></div>
                                            </div>
