...
<head>
    <title>${currentAuthoringTemplate.name}</title>
    <meta name="heading" content="${currentAuthoringTemplate.name}"/>
</head>
<body class="sub_page">
    <div class="sub_page_panel">
        <div class="box_wrapper">
            <div class="sub_page_title"><c:if test="${not empty department}">
                                    ${department.name} &raquo;
                                </c:if>${currentAuthoringTemplate.name}</div>
                ...
                <div class="col w_2-3">
                    <div id="component-1" class="row">
                        <div class="detail_two_cols_skin">
                            ...
                            <br>
                            <div class="body myCorner max_image_550 thong-bao" data-corner="bottom 5px">
                                <div class="body_content">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <seo:url var="url" prefix="/${prefixDepartmentURL}/${department.departmentID}/" value="${department.name}"/>
                                            <c:set var="groupShowProperty" value="createdDateStr"/>
                                            ...
                                            <display:table name="contentItems" cellspacing="0" cellpadding="0" style="margin-bottom: 2.5em;" requestURI="${url}"
                                                 excludedParams="category authoringTemplate" size="${item.totalItems}" sort="external" uid="tableList" partialList="true" pagesize="${item.maxPageItems}" class="table bright_blue_body" export="false"
                                                    decorator="com.banvien.portal.vms.taglibs.decorator.MyGroupTableDisplaytagDecorator">
                                                <display:column headerClass="table_header" title=" " property="createdDateStr" group="1" style="width:300px;" class="groupTitle">
                                                ...
                                                <display:column>
                                                    ...
                                                    <seo:url prefix="/${prefixDepartmentURL}/${department.departmentID}/${tableList.contentID}/" value="${tableList.title}" var="seoURL"/>
                                                    <div class="td_${tableList.createdDateStr}">
                                                        <div class="title">
