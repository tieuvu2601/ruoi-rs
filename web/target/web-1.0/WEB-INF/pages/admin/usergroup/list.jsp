...
<c:url var="url" value="/admin/usergroup/list.html"/>
    ...
    <form:form commandName="items" action="${url}" method="post" id="listForm">
        ...
        <div class="box_container" >
            ...
            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${url}"
                ...
                <display:column headerClass="table_header" property="code" escapeXml="true" sortable="true" sortName="code" titleKey="usergroup.code" style="width: 15%"/>
                <display:column headerClass="table_header" property="name" escapeXml="true" sortable="true" sortName="name" titleKey="usergroup.name" style="width: 20%"/>
                ...
                <display:column sortable="false"  headerClass="table_header" url="/admin/usergroup/edit.html"
                                            titleKey="action" style="width: 20%">
                    <a href="${editUrl}?pojo.userGroupID=${tableList.userGroupID}"><img src="<c:url value='/themes/admin/images/edit.png'/>"/></a>
                    <a name="deleteLink" id="d_${tableList.userGroupID}_a" href="<c:url value='/admin/usergroup/list.html'><c:param name="checkList" value="${tableList.userGroupID}"/><c:param name="crudaction" value="delete"/></c:url>"><img  id="d_${tableList.userGroupID}" src="<c:url value='/themes/admin/images/no.png'/>"/></a>
