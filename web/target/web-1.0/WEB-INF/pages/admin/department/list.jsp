...
<c:url var="url" value="/admin/department/list.html"/>
        ...
        <div class="box_container">
            ...
            <div class="form">
                <table width="100%" cellpadding="5" cellspacing="5" border="0">
                    <tr>
                        <td><fmt:message key="department.code"/></td>
        ...
        <br/>
         <div class="box_container" >
            ...
            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${url}"
                ...
                <display:column headerClass="table_header"  escapeXml="false" sortable="true" sortName="code" titleKey="department.code" style="width: 10%" >
                    <a href="${editUrl}?pojo.departmentID=${tableList.departmentID}">${tableList.code}</a>
                </display:column>
                ...
                <display:column sortable="false"  headerClass="table_header" url="/admin/department/edit.html"
                                            titleKey="action" style="width: 20%">
                    <a href="${editUrl}?pojo.departmentID=${tableList.departmentID}"><img src="<c:url value='/themes/admin/images/edit.png'/>"/></a>
                    <a name="deleteLink" id="d_${tableList.departmentID}_a" href="<c:url value='/admin/department/list.html'><c:param name="checkList" value="${tableList.departmentID}"/><c:param name="crudaction" value="delete"/></c:url>"><img id="d_${tableList.departmentID}" src="<c:url value='/themes/admin/images/no.png'/>"/></a>
